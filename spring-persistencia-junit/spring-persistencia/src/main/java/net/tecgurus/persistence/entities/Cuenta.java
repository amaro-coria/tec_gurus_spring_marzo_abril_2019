...
public class Cuenta implements java.io.Serializable {
	...
	public Cuenta(int idTipCta, Date fchAlt, long idEst, Date fchCre) {
	...
	public Cuenta(String noCta, int idTipCta, Date fchAlt, long idEst, Date fchCre, Date fchMod, String noTar,
			BigDecimal blncCta) {
		this.noCta = noCta;
		this.idTipCta = idTipCta;
		this.fchAlt = fchAlt;
